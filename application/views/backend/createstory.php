...
-->
						...
						<div class=" form-group">
							...
							<div class="col-sm-4">
								<?php echo form_dropdown( "visibility",$visibility,set_value( 'visibility'), "class='chzn-select form-control'");?>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-4">
								...
								<a href="<?php echo site_url("site/index"); ?>" class="btn btn-secondary">Cancel</a>
							</div>
						</div>
				</form>
				</div>

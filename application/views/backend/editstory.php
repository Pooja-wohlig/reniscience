...
<!--                    <textarea type="text" id="normal-field" class="form-control" name="content" value='<?php echo set_value(' content ',$before->content);?>'><?php echo set_value(' content ',$before->content);?></textarea>-->
			...
			<?php
			if($before->id == 14|| $before->id ==16)
			{
				echo'<div class="form-group">
					<label class="col-sm-2 control-label" for="normal-field">Image2</label>
					<div class="col-sm-4">
						<input type="file" id="normal-field" class="form-control" name="image2">
					</div>
				</div>';
			}
			?>
...
<!--			<?php print_r($selectedcategory);?>-->
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					...
					<a href='<?php echo site_url("site/viewstory"); ?>' class='btn btn-secondary'>Cancel</a>
				</div>
			</div>
		</form>
	</div>
